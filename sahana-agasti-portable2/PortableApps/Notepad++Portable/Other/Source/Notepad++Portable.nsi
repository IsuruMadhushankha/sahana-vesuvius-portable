...
Section "Main"
	...
	MoveSettings:
		...
		Rename "$SETTINGSDIRECTORY\LightExplorer.ini" "$PROGRAMDIRECTORY\plugins\LightExplorer.ini"
		...
		Rename "$SETTINGSDIRECTORY\userDefineLang.xml" "$PROGRAMDIRECTORY\userDefineLang.xml"
	...
	UpdateLightExplorerPlugin:
		IfFileExists "$PROGRAMDIRECTORY\plugins\LightExplorer.ini" "" UpdateConfig
			${ReplaceInFile} "$PROGRAMDIRECTORY\plugins\LightExplorer.ini" "$1\" "$0\"
	...
	CheckStillRunning:
		...
		Rename "$PROGRAMDIRECTORY\plugins\LightExplorer.ini" "$SETTINGSDIRECTORY\LightExplorer.ini"
		...
		Rename "$PROGRAMDIRECTORY\userDefineLang.xml" "$SETTINGSDIRECTORY\userDefineLang.xml"
		CreateDirectory "$SETTINGSDIRECTORY\plugins"
