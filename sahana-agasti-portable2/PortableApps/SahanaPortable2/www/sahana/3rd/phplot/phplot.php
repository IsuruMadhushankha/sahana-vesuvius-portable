...
/* $Id: phplot.php,v 1.5.2.2 2009-12-22 05:07:03 kethees Exp $ */
...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    var $data_colors = array('SkyBlue', 'green', 'orange', 'blue', 'gray', 'red', 'violet', 'azure1');
    var $error_bar_colors = array('SkyBlue', 'green', 'orange', 'blue', 'gray', 'red', 'violet', 'azure1');
